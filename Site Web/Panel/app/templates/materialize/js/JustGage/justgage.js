...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // color of label showing current value
    valueFontFamily: kvLookup('valueFontFamily', config, dataset, "Lato"),
    ...
    gaugeWidthScale: kvLookup('gaugeWidthScale', config, dataset, 0.9),

    // gaugeColor : string
    // background color of gauge element
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#DADFE1"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#16a085", "#16a085", "#16a085"], 'array', ','),
    ...
    valueMinFontSize: kvLookup('valueMinFontSize', config, dataset, 10),
  ...
  if (obj.config.donut === true) {
    ...
    // value
    valueFontSize = ((widgetH / 8.5) > obj.config.valueMinFontSize) ? (widgetH / 9.5) : obj.config.valueMinFontSize;
    valueX = dx + widgetW / 2;
