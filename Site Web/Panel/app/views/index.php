...
<ul class="collection with-header">
    ...
    <li class="collection-item">Pourcentage : <b><?php if($data["lastTensionBatterie"]==""){ echo "?"; }else{ echo $util->getBatteryPercentage($data["lastTensionBatterie"]); } ?></b></li>
</ul>
...
<ul class="collection with-header">
    ...
    <li class="collection-item">Puissance Instantanée : <b><?php if($data["lastPAPP"]==""){ echo "?"; }else{ echo $data["lastPAPP"] . "VA"; } ?></b></li>
